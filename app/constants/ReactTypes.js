...
export type ClassComponent<DefaultProps, Props, State> = Class<
 ...
 * ProvidedProps: The final wrapped component will not need ProvidedProps,
 * because the HOC will provide them to the inner component
 */
export type HigherOrderComponent<RequiredProps, ProvidedProps> = (<
	OriginalProps
>(
	component: FunctionalComponent<OriginalProps>
) => FunctionalComponent<RequiredProps & $Diff<OriginalProps, ProvidedProps>>) &
	(<OriginalProps, DefaultProps>(
		component: ClassComponent<DefaultProps, OriginalProps, any>
	) => FunctionalComponent<
		$Diff<RequiredProps & $Diff<OriginalProps, ProvidedProps>, DefaultProps>
	>);
